...
import {
  ...
  AgendaEventDescriptor, AgendaHeaderCellDef,
  AgendaHeaderCellDefContext, AgendaHourDef,
  AgendaHourDefContext
} from '../agenda';
...
import {
  ...
  AgendaPlanningEventContentDefContext, AgendaPlanningHourDef, AgendaPlanningHourDefContext
