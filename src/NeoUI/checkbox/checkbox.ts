 ...
 * @docs-private
 */
export const MY_CHECKBOX_CONTROL_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => MyCheckbox),
  multi: true
};


/**
 * Change event object emitted by MyCheckbox.
 */
export class MyCheckboxChange {
  /**
   * Ctor
   * @param source The source MyCheckbox of the event.
   * @param nativeEvent The native html event that triggered event
   * @param checked The new `checked` value of the checkbox.
   */
  constructor(public source: MyCheckbox, public nativeEvent: Event, public checked: boolean) {
  }
}
...
@Component({
  ...
  standalone: true,
  providers: [MY_CHECKBOX_CONTROL_VALUE_ACCESSOR],
  host: {
    'class': 'my-checkbox',
...
export class MyCheckbox {
  ...
  @Output()
  readonly change: EventEmitter<MyCheckboxChange> = new EventEmitter<MyCheckboxChange>();
  ...
  constructor(public _elementRef: ElementRef<HTMLElement>,
              ...
              @Optional() @Inject(MY_CHECKBOX_DEFAULT_OPTIONS) private _defaultOptions: MyCheckboxDefaultOptions) {
